...
Always use kode_kronical.hostname_utils.get_normalized_hostname() when working with hostnames
...
class SystemRegistryService:
    ...
    def __init__(self):
        ...
        self.table_resource = boto3.resource('dynamodb', region_name=settings.AWS_DEFAULT_REGION).Table('kode-kronical-systems-registry')
        self.table_name = 'kode-kronical-systems-registry'
